            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                    ...
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="/business/success/2" class="layui-this">个人</a></dd>
            ...
            <div class="layui-form">
                <table class="layui-table" style="width:1366px;margin-left: 20px">
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="layui-btn layui-btn-normal layui-btn-small" onclick="fk({{ $v->id }})">放款</button>
                            <button class="layui-btn layui-btn-danger layui-btn-small" onclick="jj({{ $v->id }})">拒绝</button>
                        </td>
                    </tr>
                        @endforeach
                    </tbody>
