    ...
    <div class="productRead" >
        <form class="layui-form" id="product_add">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="is_mortgage" required>
                        <?php $title = empty($list[0]) ? [] : $list[0]['property'];?>
                        <option value="不限" @if("不限" === $product['is_mortgage']) selected="" @endif>不限</option>
                        @foreach($title as $v)
