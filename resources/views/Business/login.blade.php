	...
	<body class="beg-login-bg">
			...
			<div class="beg-login-main" id="form">
				...
				<form class="layui-form" id="form-data">
					...
					<div class="layui-form-item">
						...
						<input type="text" name="account"  autocomplete="off" placeholder="手机号或者企业代码后8位" class="layui-input" @keyup.enter="login">
					</div>
					<div class="layui-form-item">
						<label class="beg-login-icon">
							<i class="layui-icon">&#xe612;</i>
						</label>
						<input type="password" name="password"  autocomplete="off" placeholder="密码" class="layui-input" @keyup.enter="login">
					</div>
				</form>
				<div class="layui-form-item">
		...
		<script>
            var form = new Vue({
                ...
                methods: {
                    login: function () {
                        $.post('/business/check',$('#form-data').serialize(),function (obj) {
							if(obj.code == 200){
							    layer.msg(obj.msg,{icon:1});
							    setTimeout(function () {
									location.href = '/business/back';
                                },1000)
							}else{
