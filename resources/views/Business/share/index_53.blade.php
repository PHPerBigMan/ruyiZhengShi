...
@section('laybar')
        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-tab-item">
                <form id="share-table3">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">所在企业类型</label>
                            <div class="layui-input-inline">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">已缴时间</label>
                            <div class="layui-input-inline">
                                <select name="life"  class="share-select">
                                    <?php $title = ['6-12','12-24','24以上'];?>
                                    @foreach($title as $v)
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">每月工资</label>
                            <div class="layui-input-inline">
                                <input type="text" name="gongZi"  autocomplete="off" class="layui-input share-input" value="{{ !empty($data->data->gongZi) }}">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                {{--<input type="text" name="onJob"  autocomplete="off" class="layui-input share-input" value="{{ !empty($data->data->onJob) }}">--}}
                                <select name="onJob"  class="share-select">
                                    <?php $title = ['1年以内','1-3年','3-5年','5-10年','10年以上'];?>
                                    @foreach($title as $v)
                                        <option value="{{ $v }}" <?php if(!empty($data->data->job) && $data->data->job == $v)echo "selected";?>>{{ $v }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="job"  class="share-select">
                                    <?php $title = ['职员','中层领导','高管'];?>
                                    @foreach($title as $v)
                                        <option value="{{ $v }}" <?php if(!empty($data->data->job) && $data->data->job == $v)echo "selected";?>>{{ $v }}</option>
                                    @endforeach
                                </select>
    ...
    <input type="hidden" id="cat_id" value="53">
@endsection
@section('js')
