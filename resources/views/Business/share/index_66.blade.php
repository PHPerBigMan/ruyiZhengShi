...
@section('laybar')
        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-tab-item">
                <form id="share-table3">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">商标类型</label>
                            <div class="layui-input-inline">
                    ...
                    <div class="layui-form">
                        ...
                        <div class="layui-upload" id="layui-upload-black">
                            <label class="layui-form-label">商标注册证书</label>

                            <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
                                <button type="button" class="layui-btn" id="add-Shangbiao">添加图片</button>
                                <div class="layui-upload-list" id="share-img-Shangbiao">
                                    @if(!empty($data->data->Shangbiao))
                                        <img src="{{ $data->data->Shangbiao }}" alt="" class="share-img" name="carjs">
                                    @endif
                                </div>
                                <input type="hidden" name="Shangbiao" id="Shangbiao" value="<?php if(isset($data->data->Shangbiao))echo $data->data->Shangbiao;?>">
                            </blockquote>
                        </div>
                </form>
            </div>
    ...
    <input type="hidden" id="cat_id" value="66">
@endsection
@section('js')
