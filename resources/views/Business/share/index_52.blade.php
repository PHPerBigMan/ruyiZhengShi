...
@section('laybar')
        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-tab-item">
                <form id="share-table3">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">营业执照类型</label>
                            <div class="layui-input-inline">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="Yin"  class="share-select">
                                    <?php $title = ['未满半年','满半年以上'];?>
                                    @foreach($title as $v)
                                        <option value="{{ $v }}" <?php if(!empty($data->data->Yin) && $data->data->Yin == $v)echo "selected";?>>{{ $v }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="allMoney"  autocomplete="off" class="layui-input share-input" value="{{ !empty($data->data->allMoney) }}">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="companyCount" id="companyCount" autocomplete="off" class="layui-input share-input" value="{{ !empty($data->data->companyCount) ? $data->data->companyCount : "" }}">
                            </div>
                        </div>
                    </div>
    ...
    <input type="hidden" id="cat_id" value="52">
@endsection
@section('js')
