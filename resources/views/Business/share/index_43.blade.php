...
@section('laybar')
        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-tab-item">
                <form id="share-table3">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">是否本人居住</label>
                            <div class="layui-input-inline">
                                <select name="is_owner_live"  class="share-select">
                                    <option value="是" <?php if(!empty($data->data->is_owner_live) && $data->data->is_owner_live == '是')echo "selected";?>>是</option>
                                    <option value="否" <?php if(!empty($data->data->is_owner_live) && $data->data->is_owner_live == '否')echo "selected";?>>否</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">是否唯一住房</label>
                            <div class="layui-input-inline">
                                <select name="only_housing"  class="share-select">
                                    <option value="是" <?php if(!empty($data->data->only_housing) && $data->data->only_housing == '是')echo "selected";?>>是</option>
                                    <option value="否" <?php if(!empty($data->data->only_housing) && $data->data->only_housing == '否')echo "selected";?>>否</option>
                                </select>
                            </div>
                        </div>
                    </div>
    ...
    <input type="hidden" id="cat_id" value="43">
@endsection
@section('js')
