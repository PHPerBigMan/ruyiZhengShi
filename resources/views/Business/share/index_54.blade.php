...
@section('laybar')
                ...
                <form id="share-table3">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="count_money"  class="share-select">
                                    <?php $title = ['1000','2000-3000','3000以上'];?>
                                    @foreach($title as $v)
                                        <option value="{{ $v }}" <?php if(!empty($data->data->count_money) && $data->data->count_money == $v)echo "selected";?>>{{ $v }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
    ...
    <input type="hidden" id="cat_id" value="54">
@endsection
@section('js')
