        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-tab-item">
                <form id="share-table3">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">借款银行</label>
                            <div class="layui-input-inline">
                                <input type="text" name="bank"  autocomplete="off" class="layui-input share-input" value="{{ !empty($data->data->bank) }}">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">银行借款金额</label>
                            <div class="layui-input-inline">
                                <input type="text" name="money"  autocomplete="off" class="layui-input share-input" value="{{ !empty($data->data->money) }}">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">银行借款到期时间</label>
                            <div class="layui-input-inline">
                                <input type="text" name="bankTime"  autocomplete="off" class="layui-input share-input" value="{{ !empty($data->data->bankTime) }}">
                            </div>
                        </div>
                    </div>
