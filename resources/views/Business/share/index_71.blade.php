...
@section('laybar')
                ...
                <form id="share-table3">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="around"  class="share-select">
                                    @foreach($property->around as $v)
                                        <option value="{{ $v }}" <?php if(!empty($data->data->around) && $data->data->around == $v)echo "selected";?>>{{ $v }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="layui-form">
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                <label class="layui-form-label">企业征信</label>
                                <div class="layui-input-inline">
    ...
    <input type="hidden" id="cat_id" value="71">
@endsection
@section('js')
