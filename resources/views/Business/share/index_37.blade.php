...
@section('laybar')
        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-tab-item">
                <form id="share-table3">
                    <input type="hidden" name="area" value="sad">
                    <div class="layui-form-item layui-form-text">
                        <label class="layui-form-label">担保需求</label>
                        <div class="layui-input-block">

                            <textarea placeholder="请输入内容" class="layui-textarea" name="other">{{ !empty($data->data->other) ? $data->data->other :"" }}</textarea>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <input type="hidden" id="cat_id" value="37">
@endsection
@section('js')
    ...
    <script src="{{ URL::asset('js/share.js') }}?_v=25"></script>
@endsection
