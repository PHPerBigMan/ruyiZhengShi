...
@section('laybar')
        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-tab-item">
                <form id="share-table3">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">产权状态</label>
                            <div class="layui-input-inline">
                                <select name="house_status"  class="share-select">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">在装修合同总金额</label>
                            <div class="layui-input-inline">
                                <input type="text" name="heTong"  autocomplete="off" class="layui-input share-input" value="{{ !empty($data->data->heTong) }}">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form">
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                <label class="layui-form-label">其他资产</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="other"  autocomplete="off" class="layui-input share-input" value="{{ !empty($data->data->other) }}">
                                </div>
                            </div>
                        </div>
                </form>
    ...
    <input type="hidden" id="cat_id" value="56">
@endsection
@section('js')
