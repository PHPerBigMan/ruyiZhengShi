...
@section('laybar')
        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-tab-item">
                <form id="share-table3">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">土地规划用途</label>
                            <div class="layui-input-inline">
                                <select name="use"  class="share-select">
                                    @foreach($property->use as $v)
                                        <option value="{{ $v }}" <?php if(!empty($data->data->use) && $data->data->use == $v)echo "selected";?>>{{ $v }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
    ...
    <input type="hidden" id="cat_id" value="24">
@endsection
@section('js')
