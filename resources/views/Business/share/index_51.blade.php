...
@section('laybar')
        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-tab-item">
                <form id="share-table3">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">保单投保人</label>
                            <div class="layui-input-inline">
                                <input type="text" name="TouBao" id="TouBao" autocomplete="off" class="layui-input share-input" value="{{ !empty($data->data->TouBao) ? $data->data->TouBao : "" }}">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">保单被保人</label>
                            <div class="layui-input-inline">
                                <input type="text" name="BeiTouBao" id="BeiTouBao" autocomplete="off" class="layui-input share-input" value="{{ !empty($data->data->BeiTouBao) ? $data->data->BeiTouBao : "" }}">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">保单收益</label>
                            <div class="layui-input-inline">
                                <input type="text" name="ShouYi" id="ShouYi" autocomplete="off" class="layui-input share-input" value="{{ !empty($data->data->ShouYi) ? $data->data->ShouYi : "" }}">
                            </div>
                        </div>
                    </div>
    ...
    <input type="hidden" id="cat_id" value="51">
@endsection
@section('js')
