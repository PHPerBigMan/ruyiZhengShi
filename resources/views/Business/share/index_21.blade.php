...
@section('laybar')
        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-tab-item">
                <form id="share-table3">
                            ...
                            <div class="layui-input-inline">
                                <select name="type"  class="share-select">
                                    @foreach($property->property as $v)
                                        <option value="{{ $v }}" <?php if(!empty($data->data->property) && $data->data->property == $v)echo "selected";?>>{{ $v }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">是否沿街</label>
                            <div class="layui-input-inline">
                                <select name="street"  class="share-select">
                                    <option value="是" <?php if(!empty($data->data->street) && $data->data->street == '是')echo "selected";?>>是</option>
                                    <option value="否" <?php if(!empty($data->data->street) && $data->data->street == '否')echo "selected";?>>否</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="floor"  autocomplete="off" class="layui-input share-input" value="{{ !empty($data->data->floor) }}">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="rent"  class="share-select">
                                    <option value="是" <?php if(!empty($data->data->rent) && $data->data->rent == '是')echo "selected";?>>是</option>
                                    <option value="否" <?php if(!empty($data->data->rent) && $data->data->rent == '否')echo "selected";?>>否</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">年租金</label>
                            <div class="layui-input-inline">
                                <input type="text" name="rent_money"  autocomplete="off" class="layui-input share-input" value="{{ !empty($data->data->rent_money) }}">
                            </div>
                        </div>
                    </div>
                    <div class="layui-upload" id="layui-upload-black">
                        <label class="layui-form-label">房产证正面</label>
                    ...
                    <div class="layui-upload" id="layui-upload-black">
                        <label class="layui-form-label">房产证背面</label>
    ...
    <input type="hidden" id="cat_id" value="23">
@endsection
@section('js')
